              ...
              <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">                           
                    ...
                    Oioi, sou o Felipe, mas meus amigos me chamam de Felps. Eu gosto muito de desenhar e espero um dia conseguir
                    trabalhar com isso (até lá vamo codando).
                    </p>
                    <br/>
                    {/* Link para seu GitHub aqui: */}
                    <a href="https://github.com/FelpsFa" className="font-normal text-yellow-500">
                      <GitHubIcon/>
                    </a>
                  </div>
                </div>
